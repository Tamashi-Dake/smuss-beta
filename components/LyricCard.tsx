...
export const LyrixCard = forwardRef<LyrixCardElement, LyrixCardProps>(
  (
    {
      title = "The Awakening - Onlap",
      lrc,
      src = "/ONLAP - The Awakening.mp3",
      height = "62vh",
      className = "",
      theme = "lyrix",
    ...
    return (
      <div
        className={
          "flex flex-col justify-center items-center gap-12 max-w-xl h-full px-6 py-10 sm:h-fit sm:px-12 sm:py-12 bg-black/5 rounded-2xl shadow-xl " +
          className
        }
      >
        <Lyrix
        ...
        <div className="flex flex-row justify-left items-center h-10 w-full gap-5 mb-[-0.7rem]">
          <button
            ...
            className="bg-transparent border-none outline-none focus:border-none focus:outline-none w-fit p-0 m-[-4px] mb-[-6px]"
            style={{
              color: highlightColor,
              transform:
                "scaleX(" + controlsScale + ") scaleY(" + controlsScale + ")",
            }}
          >
            {usePlayIcon ? (
          ...
          <span
            className="inline-flex h-full items-center flex-1 "
            style={{
              color: highlightColor,
              fontSize: Math.round(controlsScale * 150) / 100 + "rem",
              lineHeight: "2rem",
            }}
          >
            {title}
          ...
          <button
            ...
            className="bg-transparent border-none outline-none focus:border-none focus:outline-none w-fit p-0 mb-[-2px]"
            style={{
              color: highlightColor,
              transform:
                "scaleX(" + controlsScale + ") scaleY(" + controlsScale + ")",
              opacity: disableMuteButton ? 0.5 : 1,
            }}
          >
            {muted ? (
